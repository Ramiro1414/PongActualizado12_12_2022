    ...
    while UserInJugar do
        begin
            ...
            tecla:= readkey;
                ...
                if (tecla = #49) then {si usuario ingresa 1}
                    begin
                        PlaySound('GamemodeSelect.wav',0,1);
                        ClearDevice;
                        PONG1VSIA_FACIL;
                    end; {1}
                if (tecla = #50) then {si usuario ingresa 2}
                    begin
                        PlaySound('GamemodeSelect.wav',0,1);
                        ClearDevice;
                        PONG1VSIA_INTERMEDIO;
                    end; {2}
                if (tecla = #51) then {si usuario ingresa 3}
                    begin
                        PlaySound('GamemodeSelect.wav',0,1);
                        ClearDevice;
                        PONG1VSIA_DIFICIL;
                    end; {3}
                if (tecla = #52) then {si usuario ingresa 4}
                    begin
                        PlaySound('GamemodeSelect.wav',0,1);
                        ClearDevice;
                        PONG1V1;
